...
namespace Security.Core.Repositories
{
    public interface IAccountRepository
    {
        ...
        Task CreateAuthenticationToken(Accounts account, string refreshToken, CancellationToken cancellationToken);
        ...
        Task<List<Accounts>> FindByGrupo(string idGrupo, CancellationToken cancellationToken);
        ...
        Task RemoveAuthenticationToken(Accounts account, CancellationToken cancellationToken);
    }
}
